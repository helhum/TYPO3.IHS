...
class Version20140917125316 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("CREATE TABLE typo3_ihs_domain_model_link (persistence_object_identifier VARCHAR(40) NOT NULL, uri VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
		$this->addSql("CREATE TABLE typo3_ihs_domain_model_producttype (persistence_object_identifier VARCHAR(40) NOT NULL, value VARCHAR(255) NOT NULL, PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
		$this->addSql("CREATE TABLE typo3_ihs_domain_model_productversion (persistence_object_identifier VARCHAR(40) NOT NULL, versionnumber INT NOT NULL, PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
		$this->addSql("CREATE TABLE typo3_ihs_domain_model_advisory (identifier VARCHAR(255) NOT NULL, publishingdate DATETIME DEFAULT NULL, title VARCHAR(255) NOT NULL, abstract LONGTEXT NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(identifier)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
		$this->addSql("CREATE TABLE typo3_ihs_domain_model_advisory_links_join (ihs_advisory VARCHAR(255) NOT NULL, ihs_link VARCHAR(40) NOT NULL, INDEX IDX_E91447E2B09C3507 (ihs_advisory), INDEX IDX_E91447E232C207E3 (ihs_link), PRIMARY KEY(ihs_advisory, ihs_link)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
		...
		$this->addSql("CREATE TABLE typo3_ihs_domain_model_issue_affectedversions_join (ihs_issue VARCHAR(40) NOT NULL, ihs_productversion VARCHAR(40) NOT NULL, INDEX IDX_959E56A6E1103CE8 (ihs_issue), INDEX IDX_959E56A634712B07 (ihs_productversion), PRIMARY KEY(ihs_issue, ihs_productversion)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
		$this->addSql("CREATE TABLE typo3_ihs_domain_model_issue_links_join (ihs_issue VARCHAR(40) NOT NULL, ihs_link VARCHAR(40) NOT NULL, INDEX IDX_A72A871BE1103CE8 (ihs_issue), INDEX IDX_A72A871B32C207E3 (ihs_link), PRIMARY KEY(ihs_issue, ihs_link)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
		$this->addSql("CREATE TABLE typo3_ihs_domain_model_product (persistence_object_identifier VARCHAR(40) NOT NULL, type VARCHAR(40) DEFAULT NULL, name VARCHAR(255) NOT NULL, shortname VARCHAR(255) NOT NULL, INDEX IDX_8965B52B8CDE5729 (type), PRIMARY KEY(persistence_object_identifier)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
		$this->addSql("CREATE TABLE typo3_ihs_domain_model_product_versions_join (ihs_product VARCHAR(40) NOT NULL, ihs_productversion VARCHAR(40) NOT NULL, INDEX IDX_299BD1B68920987C (ihs_product), INDEX IDX_299BD1B634712B07 (ihs_productversion), PRIMARY KEY(ihs_product, ihs_productversion)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
		...
		$this->addSql("CREATE TABLE typo3_ihs_domain_model_solution_fixedinversions_join (ihs_solution VARCHAR(40) NOT NULL, ihs_productversion VARCHAR(40) NOT NULL, INDEX IDX_BE2EB7DC6EBDA105 (ihs_solution), INDEX IDX_BE2EB7DC34712B07 (ihs_productversion), PRIMARY KEY(ihs_solution, ihs_productversion)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
		$this->addSql("CREATE TABLE typo3_ihs_domain_model_solution_links_join (ihs_solution VARCHAR(40) NOT NULL, ihs_link VARCHAR(40) NOT NULL, INDEX IDX_FF25247E6EBDA105 (ihs_solution), INDEX IDX_FF25247E32C207E3 (ihs_link), PRIMARY KEY(ihs_solution, ihs_link)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
